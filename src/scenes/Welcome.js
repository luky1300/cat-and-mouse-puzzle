const WelcomeScene = {
  ...
  create: function create() {
    ...
    this.add.text(
      80,
      50,
      `Welcome to online version of the GoGetter's ‍Cat ‍& Mouse game!`,
      { fill: "#3a55b4", fontFamily: "Roboto", fontSize: "32px" }
    );
    ...
    this.add
      .rectangle(500, 730, 300, 100, 0x81de76)
      .setInteractive()
      .on(
        "pointerdown",
